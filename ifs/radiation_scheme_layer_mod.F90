...
! Enable McICA-specific field-type setup when McICA solver is used
LOGICAL :: LUSE_MCICA
...
LUSE_MCICA = (RAD_CONFIG%I_SOLVER_SW == ISolverMcICA &
...
CALL SINGLE_LEVEL_FIELD%INIT(NBLKS, NRPROMA, YRADIATION%YRERAD%NSW, YRADIATION%YRERAD%NLWEMISS, &
     &                      USE_SW_ALBEDO_DIRECT=.TRUE., USE_MCICA=LUSE_MCICA, ISEED=ISEED)
...
CALL SINGLE_LEVEL_FIELD%INIT(NBLKS, NRPROMA, YRADIATION%YRERAD%NSW, YRADIATION%YRERAD%NLWEMISS, &
     &                      USE_SW_ALBEDO_DIRECT=.TRUE., ON_GPU=.TRUE., USE_MCICA=LUSE_MCICA, ISEED=ISEED)
CALL SINGLE_LEVEL_FIELD%UPDATE_SINGLE_LEVEL(SINGLE_LEVEL)
