  ...
  do jrepeat = 1,driver_config%nrepeat
     ...
     call nvtxStartRange("ecrad_it")
      ...
      do jrl=1,ncol,nproma
        ...
        !$acc update device(zrgp(1:il,1:zrgp_fields%ifldstot,ib)) async(1)
        ...
        call radiation_scheme &
             ...
             &  lacc=yradiation%yrerad%lerad_on_gpu &
#ifdef BITIDENTITY_TESTING
...
#endif
             & )
          !$acc update host(zrgp(1:il,1:zrgp_fields%ifldstot,ib)) async(1)
          !$acc end data
      end do
#ifndef _OPENACC
      !$OMP END PARALLEL DO
