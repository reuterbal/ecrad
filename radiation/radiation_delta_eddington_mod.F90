...
!
! This file provides reimplementations of the routines in delta_eddington.h
! but inside a module. This is a work around to get the neccessary type
! information attached to the routines when processing with Loki.
!


module radiation_delta_eddington_mod
...
end module radiation_delta_eddington_mod
